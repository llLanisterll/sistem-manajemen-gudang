    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif(Auth::user()->role === 'manager')
                ...
                <x-responsive-nav-link :href="route('manager.transactions.index')" :active="request()->routeIs('manager.transactions.*')">
                    {{ __('Transactions') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('manager.restock.index')" :active="request()->routeIs('manager.restock.*')">
                    {{ __('Restock Order') }}
                </x-responsive-nav-link>
            ...
            @elseif(Auth::user()->role === 'staff')
                ...
                <x-responsive-nav-link :href="route('staff.transactions.index')" :active="request()->routeIs('staff.transactions.*')">
                    {{ __('Transactions') }}
                </x-responsive-nav-link>
            ...
            @elseif(Auth::user()->role === 'supplier')
                ...
                <x-responsive-nav-link :href="route('supplier.restock.index')" :active="request()->routeIs('supplier.restock.*')">
                    {{ __('Pesanan Masuk (PO)') }}
                </x-responsive-nav-link>
